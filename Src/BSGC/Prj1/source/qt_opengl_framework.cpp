...
void Qt_Opengl_Framework::kernel_mean()
{
	//*kernel_mean, kernel_median_quick, kernel_median_bubble, kernel_windyga, kernel_center
	MBOX = new Ui_MyMessageBox();
	MBOX->show();
	MBOX->setWindowTitle("Mean_N");
	MBOX->label->setText("Kernel size");
	connect(MBOX->pushButton, SIGNAL(clicked()), this, SLOT(OnMeanFilter()));
	//connect(MBOX->pushButton, SIGNAL(clicked()), this, SLOT(OnMedianFilter_Quick()));
	//connect(MBOX->pushButton, SIGNAL(clicked()), this, SLOT(OnMedianFilter_Bubble()));
	//connect(MBOX->pushButton, SIGNAL(clicked()), this, SLOT(OnWindygaiFilter()));
	//connect(MBOX->pushButton, SIGNAL(clicked()), this, SLOT(OnCentralWeightedMedian()));
}
void Qt_Opengl_Framework::kernel_median_quick()
{
	//*kernel_mean, kernel_median_quick, kernel_median_bubble, kernel_windyga, kernel_center
	MBOX = new Ui_MyMessageBox();
	MBOX->show();
	MBOX->setWindowTitle("Median_Quick_N");
	MBOX->label->setText("Kernel size");
	connect(MBOX->pushButton, SIGNAL(clicked()), this, SLOT(OnMedianFilter_Quick()));
}
void Qt_Opengl_Framework::kernel_median_bubble()
{
	//*kernel_mean, kernel_median_quick, kernel_median_bubble, kernel_windyga, kernel_center
	MBOX = new Ui_MyMessageBox();
	MBOX->show();
	MBOX->setWindowTitle("Median_Bubble_N");
	MBOX->label->setText("Kernel size");
	connect(MBOX->pushButton, SIGNAL(clicked()), this, SLOT(OnMedianFilter_Bubble()));
}
void Qt_Opengl_Framework::kernel_windyga()
{
	//*kernel_mean, kernel_median_quick, kernel_median_bubble, kernel_windyga, kernel_center
	MBOX = new Ui_MyMessageBox();
	MBOX->show();
	MBOX->setWindowTitle("Windyga_N");
	MBOX->label->setText("Kernel size");
	connect(MBOX->pushButton, SIGNAL(clicked()), this, SLOT(OnWindygaiFilter()));
}
void Qt_Opengl_Framework::kernel_center()
{
	//*kernel_mean, kernel_median_quick, kernel_median_bubble, kernel_windyga, kernel_center
	MBOX = new Ui_MyMessageBox();
	MBOX->show();
	MBOX->setWindowTitle("CenterWeightedMedian_N");
	MBOX->label->setText("Kernel size");
	connect(MBOX->pushButton, SIGNAL(clicked()), this, SLOT(OnCentralWeightedMedian()));
}
//
...
void Qt_Opengl_Framework::OnMeanFilter()
{
	MBOX->hide();
	application->Filter_Mean(MBOX->getMyInt());
}

void Qt_Opengl_Framework::OnMedianFilter_Quick()
{
	MBOX->hide();
	application->Filter_Median_Quick(MBOX->getMyInt());
}

void Qt_Opengl_Framework::OnMedianFilter_Bubble()
{
	MBOX->hide();
	application->Filter_Median_Bubble(MBOX->getMyInt());
}

void Qt_Opengl_Framework::OnWindygaiFilter()
{
	MBOX->hide();
	application->Filter_Windyga(MBOX->getMyInt());
}
void Qt_Opengl_Framework::OnCentralWeightedMedian() {
	MBOX->hide();
	application->Filter_CentralWeightedMedian(MBOX->getMyInt());
}
