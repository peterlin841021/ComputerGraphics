...
public:
	...
	// Filter
	void filter(int n, bool centerweighted);
	void filtering(double **filter);
	void filtering_N(double **filter, int n);
	void Filter_Box();
	...
	void Filter_Enhance();
	//New 
	void Filter_Mean(int k);
	void Filter_Median_Quick(int k);
	void Filter_Median_Bubble(int k);
	void Filter_Windyga(int k);	
	void Filter_CentralWeightedMedian(int k);
	// Size
	void Half_Size();
	void Double_Size();
