...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->hkoglPanelControl2->Location = System::Drawing::Point(127, 119);
			...
			this->hkoglPanelControl2->Size = System::Drawing::Size(150, 150);
...
private: System::Void openModelDialog_FileOk(System::Object^  sender, System::ComponentModel::CancelEventArgs^  e)
{
	...
	mesh = new Tri_Mesh;	
	mesh->init_shader(mesh->shaderprogram, mesh->VAO, mesh->V_VBO);
	printf("sp:%d vao:%d vbo:%d\n", mesh->VAO, mesh->V_VBO);
